...
/**
 * Aborts the test execution with an optional message.
 * @param {string} message - Optional message explaining why tests were aborted.
 */
export function abort(message = 'Test execution aborted') {
	progress.aborted = true;
	progress.abortMessage = message;
	progress.addLog(
		`${colors.YELLOW("⚠")} ${colors.YELLOW(message)}`,
		"log",
	);
}
